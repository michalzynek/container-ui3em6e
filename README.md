...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ui3em6e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ui3em6e.containers.anotherwebservice.com/
...
```
git clone git@github.com:michalzynek/container-ui3em6e.git
cd container-ui3em6e
```
...
```
docker attach container-ui3em6e
```
